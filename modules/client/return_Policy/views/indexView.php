 ...
 <hr class="display-4">
    ...
    <div class="container-returnpolicy">
        <div class="row-text-center">
            <h1><a href="/du_an_1_poly_hotel/?role=client">Trang chủ</a>/ <a href="/du_an_1_poly_hotel/?role=client&mod=return_Policy&action=index">Trang chính sách đổi trả</a></h1>
            <div class="col-text">
