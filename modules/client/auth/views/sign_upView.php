            ...
            <div class="row mt-5">
                ...
                <div class="col-md-6 mt-5">
                    ...
                    <form action="/MiuStore/?role=client&mod=auth&action=saveSignUp" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-6 ">
                                <!-- <label for="my-login">Email</label> -->
                                <input id="my-login" class="form-control border-bottom"  type="password" name="password" placeholder="Mật khẩu">
                            </div>
                            <div class="form-group col-lg-6 ">
                                <!-- <label for="my-login">Email</label> -->
                                <input id="my-login" class="form-control border-bottom"  type="password" name="nhaplaipassword" placeholder="Nhập lại mật khẩu">
                            </div>
                        </div>
                        <div class="form-group">
                            <!-- <label for="my-login">Email</label> -->
                            <input id="my-login" class="form-control border-bottom"  type="number" name="numberphone" placeholder="Số điện thoại" >
                        </div>
                        <div class="form-group">
                            <label for="my-login">
                    ...
                    <?php endforeach; ?>
                        ...
                        <div class="form-group">
                            <!-- <label for="my-login">Email</label> -->
                            <input id="my-login" class="form-control border-bottom bg-success text-white"   type="submit" name="" value="Tạo tài khoản">
                        </div>
